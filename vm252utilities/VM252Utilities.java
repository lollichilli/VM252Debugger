...
public class VM252Utilities {
    ...
    //
    // Public Class Method byte [] readObjectCodeFromObjectFile(String
    // objectFileName)
    //
    // Purpose:
    ...
    public static byte[] readObjectCodeFromObjectFile(String objectFileName) {
        ...
        try {
            ...
            final FileInputStream objectFile = new FileInputStream(new File(objectFileName));
            ...
            final int objectCodeSize = (byte3 & 0xff) << 24 | (byte2 & 0xff) << 16
            ...
            final int sourceFileInformationSize = (byte3 & 0xff) << 24 | (byte2 & 0xff) << 16
                    | (byte1 & 0xff) << 8 | byte0 & 0xff;
            ...
            final int executableSourceLineMapSize = (byte3 & 0xff) << 24 | (byte2 & 0xff) << 16
                    | (byte1 & 0xff) << 8 | byte0 & 0xff;
            ...
            final int symbolicAddressInformationSize = (byte3 & 0xff) << 24 | (byte2 & 0xff) << 16
                    | (byte1 & 0xff) << 8 | byte0 & 0xff;
            ...
            final int byteContentMapSize = (byte3 & 0xff) << 24 | (byte2 & 0xff) << 16
                    | (byte1 & 0xff) << 8 | byte0 & 0xff;
            ...
            int sourceFileNameReadStatus = objectFile.read(sourceFileInformation);
            ...
            executableSourceLineMap = new byte[executableSourceLineMapSize];

            int executableSourceLineMapReadStatus = objectFile.read(executableSourceLineMap);
            ...
            symbolicAddressInformation = new byte[symbolicAddressInformationSize];

            int symbolicAddressInformationReadStatus = objectFile.read(symbolicAddressInformation);
